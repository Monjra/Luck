...
@section("admin")
            ...
            <xblock><a href="/goods/create"><button class="layui-btn" ><i class="layui-icon">&#xe608;</i>添加</button></a><span class="x-right" style="line-height:40px">共有数据：{{count($comments)}}条</span></xblock>
            <table class="layui-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-manage">
                        	<a title="填写回复" href="/comments/{{$v->id}}/edit"  style="text-decoration:none">
        ...
        function member_stop(obj,id,status){
            $.get("/goodss",{id:id,status:status},function(data){
                // alert(data);
                if(data==0){
